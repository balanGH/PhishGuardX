...
# -----------------------------
MODEL_DIR = "./distilbert_url_model"
try:
...
@app.get("/myorders/html", response_class=HTMLResponse)
...
def root():
    ...
    return {
        ...
        "version": "1.0",
        "endpoints": {
            "/myorders": "JSON phishing analysis",
            "/myorders/html": "HTML phishing analysis",
